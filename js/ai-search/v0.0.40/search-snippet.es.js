...
const oe = "0.0.40", le = `<svg width="32" height="10" viewBox="0 0 412 186" xmlns="http://www.w3.org/2000/svg" aria-label="Cloudflare" role="img">
...
</svg>`, ce = "https://workers.cloudflare.com/product/ai-search", M = `Powered by <a href="${ce}" target="_blank" rel="noopener noreferrer">Cloudflare AI Search ${le}</a>`, he = 2e4, de = 20, pe = "/stats";
function $() {
